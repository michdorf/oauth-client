...
define("randomstr", ["require", "exports"], function (require, exports) {
    "use strict";
...
define("codeverifier", ["require", "exports", "randomstr"], function (require, exports, randomstr_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("oauthclient", ["require", "exports", "randomstr", "codeverifier", "../node_modules/.pnpm/github.com+michdorf+moduli@b55620e79347a672335c7f99d196bdbeebc8fbed/node_modules/moduli/moduli/ajax"], function (require, exports, randomstr_2, codeverifier_1, ajax_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class OAuthClient {
        constructor(config) {
        ...
        authorizationCode(scopes, usePCKE) {
            ...
            const stateId = randomstr_2.default(16);
            scopes = encodeURIComponent(scopes);
            let redirectUri = encodeURIComponent(this.config.redirect_uri || "");
            const codeVerifier = usePCKE ? randomstr_2.default() : "";
            this.requests.push({
                type: 'code',
                state: stateId,
        ...
        clientCredentials(scopes, headers) {
            const stateID = randomstr_2.default(12);
            this.requests.push({
...
define("index", ["require", "exports", "../node_modules/.pnpm/github.com+michdorf+moduli@b55620e79347a672335c7f99d196bdbeebc8fbed/node_modules/moduli/moduli/ajax", "oauthclient"], function (require, exports, ajax_2, oauthclient_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        if (confirm("Er du klar?")) {
            ...
            if (window.location.hash.indexOf("code=") !== -1 || window.location.search.indexOf("code=") !== -1) {
                ...
                setTimeout(() => {
                    ...
                    ajax_2.default(`https://dechiffre.dk/oauth2-demo-php/my-oauth2/resource.php`, {
